...
public class CharMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (movementVector.magnitude != 0)
        {
            ...
            transform.rotation = Quaternion.Lerp(transform.rotation, Quaternion.LookRotation(movementVector, Vector3.up),
        ...
        walkAnim.SetBool("isWalk", isWalking);

        walkAnim.SetFloat("SpeedValue", direction.magnitude);
